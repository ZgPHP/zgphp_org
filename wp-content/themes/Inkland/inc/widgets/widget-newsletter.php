...
class App_Newsletter extends WP_Widget {
   ...
   function App_Newsletter() {
       ...
       parent::WP_Widget(false, $name = __('Inkland - Newsletter', 'inkland'), $widget_ops);
   }
   ...
   function form($instance) {
		...
		?>
       <p>
	   	 <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:','inkland'); ?></label>
	       <input type="text" name="<?php echo $this->get_field_name('title'); ?>"  value="<?php echo $title; ?>" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" />
       </p>
       <p>
	   	 <label for="<?php echo $this->get_field_id('newsletter_text'); ?>"><?php _e('Newsletter Text:','inkland'); ?></label>
       ...
       <p>
	   	 <label for="<?php echo $this->get_field_id('service'); ?>"><?php _e('Chose Service:', 'inkland'); ?></label><br/>
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('mailchimp_key'); ?>"><?php _e('MailChimp API Key:','inkland'); ?></label><br/>
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('mailchimp_list'); ?>"><?php _e('MailChimp API List:','inkland'); ?></label><br/>
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('sendloop_user'); ?>"><?php _e('Sendloop Username:','inkland'); ?></label><br/>
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('sendloop_list'); ?>"><?php _e('Sendloop List ID:','inkland'); ?></label><br/>
