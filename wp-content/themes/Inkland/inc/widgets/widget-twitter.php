...
class App_Twitter extends WP_Widget {
   ...
   function App_Twitter() {
       ...
       parent::WP_Widget(false, __('Inkland'.' - Twitter Stream', 'inkland'),$widget_ops);
   }
   ...
   function form($instance) {
       ...
       <p>
	   	 <label for="<?php echo $this->get_field_id('username'); ?>"><?php _e('Username:', 'inkland'); ?></label>
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Number of tweets:','inkland'); ?></label>
