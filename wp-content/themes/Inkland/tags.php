		...
		<?php if(have_posts()) :  while(have_posts()) : the_post(); ?>
                ...
                <div class="blog-one left">
                    ...
                    <div class="post-date-content right">
                        <ul>
                            <li><span><?php _e("Posted:", 'inkland')?></span></li>
                            <li><?php echo get_the_date()?></li>
                        </ul>
                        <ul>
                            <li><span><?php _e("Categories:", 'inkland')?></span></li>
                            <li><?php echo get_the_category_list( '&nbsp; &nbsp;|&nbsp; &nbsp;', $post->ID ); ?></li>
                        </ul>
                        <ul>
                            <li><span><?php _e("Comments:", 'inkland')?></span><p><?php comments_number( '0', '1', '%' ); ?></p></li>
                        </ul>
                    </div><!--/post-date-->
                    <div class="post-text left">
                        <p><?php the_excerpt()?></p>
                    </div><!--/text-->
                    <div class="more-info left"><a href="<?php the_permalink()?>"><?php _e("Read more", 'inkland')?></a></div><!--/call-action-text-->
                </div><!--/content-one-->
