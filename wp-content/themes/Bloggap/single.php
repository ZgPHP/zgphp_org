...
?>
            ...
            <style type="text/css">
                ...
                .single-color<?php echo $c; ?> .blog-title a, .single-color<?php echo $c; ?> .single-title, .thecomments h2,  .single-color<?php echo $c; ?> .comment-start-title span, .comment-start-title p, .comment-start-text p, .comment-start-title a {
                ...
                .single-color<?php echo $c; ?> .blog-text p, .shortcodes ol li, .shortcodes ul li,  .gallery-single-prev p a, .gallery-single-next p a {
                ...
                .single-color<?php echo $c; ?> .blog-read-more a:hover, .more-link:hover {
               ...
               <?php if($format !== 'aside') { ?>
                   <div class="blog-category left">
                        ...
                        <ul>
                            ...
                            <li><span><?php comments_number( 'No Comments', 'One Comment', '% Comments' ); ?>.</span></li>
                        </ul>
            ...
            <?php if($show_share) { ?>
              <div class="gallery-share left">
                  <div class="gallery-facebook left">
                       <a target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo get_permalink(); ?>&t=<?php get_the_title(); ?>">
                              <span>
                                <?php
                  ...
                  <div class="gallery-twitter left">
                      <a target="_blank" href="https://twitter.com/sharer?url=<?php the_permalink(); ?>&text=<?php the_title(); ?>" class="twitter-share-button">
                          <span>
                              <?php
